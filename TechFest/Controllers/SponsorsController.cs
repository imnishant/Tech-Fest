...
namespace TechFest.Controllers
{
    public class SponsorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "organization,category,amount")] Sponsor sponsor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "organization,category,amount")] Sponsor sponsor)
        {
            if (ModelState.IsValid)
            {
